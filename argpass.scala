...
object argpass {
  ...
  def refint1 (f : RefInt => Unit) : (Int, Int, Int) = {
    ...
    val r:RefInt = new RefInt(0)
    ({f(r); val n1:Int = r.get; n1},{f(r); val n2:Int = r.get; n2},{f(r); val n3:Int = r.get; n3})
  }
  ...
  def refint2 (f : RefInt => Unit) : (Int, Int, Int) = {
    ...
    val r1:RefInt = new RefInt(0)
    val r2:RefInt = new RefInt(0)
    val r3:RefInt = new RefInt(0)
    val g1 = ()=>f(r1); val g2 = ()=>f(r2); val g3 = ()=>f(r3)
    g1();g2();g3();
